            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
              ...
              <Box sx={{ display: 'flex', gap: 2 }}>
                <Button
                  variant="contained"
                  startIcon={<PdfIcon />}
                  onClick={() => window.open(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:7000'}/projects/${projectId}/boq/export/pdf`, '_blank')}
                  sx={{
                ...
                <Button
                  ...
                  onClick={() => window.open(`${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:7000'}/projects/${projectId}/boq/export`, '_blank')}
                >
                  ייצא ל-Excel
                </Button>
              </Box>
